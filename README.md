# Это репозитория в котором были выполнены задачи по SQL на курсе MOST Java Backend Access
<h2> Схема Базы данных</h2>
![image](https://github.com/user-attachments/assets/e0113eea-334f-4725-a854-7a093aff89db)
